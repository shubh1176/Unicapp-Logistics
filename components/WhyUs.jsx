...
function WhyUs() {
  return (
    <div className="relative bg-[#202020] flex flex-col items-center gap-4 sm:gap-6 md:gap-8 mb-7 pb-5  sm:pt-20 md:pt-10">
      ...
      <span className="bg-[#394360] text-[#7CC4F8] rounded-lg py-1 px-4 sm:px-6 md:px-8 font-generalMedium mt-10 sm:mt-20 z-10 text-xs sm:text-base md:text-lg">
        WHY US?
      </span>
