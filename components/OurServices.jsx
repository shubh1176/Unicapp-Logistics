  ...
  return (
    <div className='bg-[#fefae060]'>
      <div className='flex flex-col items-center gap-10 border-solid bg-[#ffffffa3] px-4 md:px-8 pb-5 pt-16 mt-10 mb-10 mx-4 md:mx-12 lg:mx-24 rounded-3xl shadow-lg transition-all duration-300 ease-in-out'>
        <span className='bg-[#7cc4f851] text-[#4B8EBF] rounded-lg py-2 px-3 font-generalMedium transition-all duration-300 ease-in-out'>OUR SERVICES</span>
        <div className='text-center transition-all duration-300 ease-in-out'>
          <h2 className='text-[#000000] font-filson text-4xl md:text-6xl'>One-stop solution for all</h2>
          <h2 className='text-[#000000] font-filson text-4xl md:text-6xl'>your delivery needs</h2>
        </div>

        <div className='text-center transition-all duration-300 ease-in-out'>
          <span className='font-generalRegular text-xl md:text-2xl'>A personal <span className='font-generalRegular text-[#9E3CE1] text-xl md:text-2xl'>delivery</span> partner for everyone</span>
        </div>

        {/* Service Cards for Small Screens */}
        <div className='grid grid-cols-2 gap-4 md:hidden mb-8 mt-8 mx-4 md:mx-8 md:px-12 lg:px-56 transition-all duration-300 ease-in-out'>
          <div className='flex flex-col items-center transition-all duration-300 ease-in-out'>
            ...
            <div className='w-40 md:w-60 mt-0 hover:cursor-pointer transition-all duration-300 ease-in-out' onClick={() => router.replace('/Pickup-and-drop')}>
              <span className='flex flex-row justify-between bg-black rounded-2xl p-2'>
                ...
                <Button className="rounded-full bg-[#9E3CE1] border-spacing-1 p-2 hover:bg-[#9E3CE1] transition-all duration-300 ease-in-out"><LucideArrowUpRight /></Button>
              </span>
            </div>
          </div>
          <div className='flex flex-col items-center transition-all duration-300 ease-in-out'>
            ...
            <div className='w-40 md:w-60 mt-0 hover:cursor-pointer transition-all duration-300 ease-in-out' onClick={() => router.replace('/courier')}>
              <span className='flex flex-row justify-between bg-black rounded-2xl p-2'>
                ...
                <Button className="rounded-full bg-[#9E3CE1] border-spacing-1 p-2 hover:bg-[#9E3CE1] transition-all duration-300 ease-in-out" onClick={() => router.replace('/courier')}><LucideArrowUpRight /></Button>
              </span>
            </div>
          </div>
        </div>
          ...
          <div className='flex flex-col items-center transition-all duration-300 ease-in-out'>
            ...
            <div className='w-40 md:w-60 mt-0 hover:cursor-pointer transition-all duration-300 ease-in-out' onClick={() => router.replace('/businesses')}>
              <span className='flex flex-row justify-between bg-black rounded-2xl p-2'>
                ...
                <Button className="rounded-full bg-[#9E3CE1] border-spacing-1 p-2 hover:bg-[#9E3CE1] transition-all duration-300 ease-in-out" onClick={() => router.replace('/businesses')}><LucideArrowUpRight /></Button>
              </span>
            </div>
          </div>
        </div>
