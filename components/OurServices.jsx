...
function OurServices() {
  ...
  return (
    <div className='bg-[#fefae060]'>
      <div className='flex flex-col items-center gap-10 border-solid bg-[#ffffffa3] px-1 py-5 mt-10 mb-10 mx-24 rounded-3xl shadow-lg'>
        ...
        <div className='flex flex-row gap-7 mb-8 mt-16'>
          <div className='flex flex-col items-center'>
            ...
            <div className='w-72 mt-0'>
              <span className='flex flex-row justify-between bg-black rounded-2xl p-2'>
                ...
                <Button className="rounded-full bg-[#9E3CE1] border-spacing-1 p-2 hover:bg-[#9E3CE1]" onClick={()=>router.replace('/Pickup-and-drop')}><LucideArrowUpRight/></Button>
              </span>
            </div>
          </div>
          <div className='flex flex-col items-center'>
