      ...
      <div className='flex flex-col items-center gap-10 border-solid bg-[#ffffffa3] px-4 md:px-8 pb-5 pt-16 mt-10 mb-10 mx-4 md:mx-12 lg:mx-24 rounded-3xl shadow-lg transition-all duration-300 ease-in-out'>
        ...
        <div className='grid grid-cols-2 gap-4 md:hidden mb-8 mt-8 mx-4 md:mx-8 md:px-12 lg:px-56 transition-all duration-300 ease-in-out'>
          <div className='flex flex-col items-center transition-all duration-300 ease-in-out'>
            <div className='bg-[#F8EBAB] h-44 w-44 md:h-60 md:w-60 rounded-2xl flex justify-center items-center transition-all duration-300 ease-in-out'>
              <Image src={'/images/groupimage.svg'} height={160} width={160} alt="Pickup & Drop" />
            </div>
            <div className='w-44 md:w-60 mt-2 hover:cursor-pointer transition-all duration-300 ease-in-out' onClick={() => router.replace('/Pickup-and-drop')}>
          ...
          <div className='flex flex-col items-center transition-all duration-300 ease-in-out'>
            ...
            <div className='w-44 md:w-60 mt-2 hover:cursor-pointer transition-all duration-300 ease-in-out' onClick={() => router.replace('/courier')}>
              <span className='flex flex-row justify-between bg-black rounded-2xl p-1'>
                <span className='font-generalRegular text-white py-2 px-2 space-x-1 text-sm'>
                  Intercity Courier
                </span>
