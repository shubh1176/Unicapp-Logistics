...
function Faq() {
  ...
  return (
    <div className='flex flex-col text-lg md:text-xl mb-5'>
        <div className='justify-center items-center flex flex-col'>
            <div className='mb-3'>
                <span className='text-2xl md:text-4xl font-filson'>FREQUENTLY ASKED QUESTIONS</span>
            </div>
            <div className='flex flex-row gap-2'>
                ...
                <div className='flex flex-row gap-1 hover:cursor-pointer hover:underline' onClick={()=>router.push('/Faqs')}>
                    ...
                    <ArrowRight size={16} strokeWidth={2} className='mt-1.5 text-[#470A68]'/>
                </div>
            </div>

        </div>
        <div className='border-2 border-opacity-50 border-gray-950 rounded-2xl md:rounded-3xl mx-8 md:mx-40 mt-6 md:mt-10 pb-4 px-5 md:px-9'>
            <Accordion type="single" collapsible>
                <AccordionItem value="item-1" className='pt-4'>
                    ...
                    <AccordionContent className='font-generalLight text-sm md:text-lg'>
