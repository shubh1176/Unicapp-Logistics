...
function Faq() {
  ...
  return (
    <div className="flex flex-col text-base sm:text-lg md:text-xl mb-5">
      {/* FAQ Heading */}
      <div className="justify-center items-center flex flex-col px-4 sm:px-6">
        <div className="mb-3 text-center">
          <span className="text-xl sm:text-2xl md:text-4xl font-filson">FREQUENTLY ASKED QUESTIONS</span>
        </div>
        <div className="flex flex-row gap-2 text-sm sm:text-base">
          ...
          <div className="flex flex-row gap-1 hover:cursor-pointer hover:underline" onClick={() => router.push('/Faqs')}>
            ...
            <ArrowRight size={16} strokeWidth={2} className="mt-0.5 text-[#470A68]" />
          </div>
        </div>
      </div>

      {/* Accordion Section */}
      <div className="border-2 border-opacity-50 border-gray-950 rounded-xl sm:rounded-2xl md:rounded-3xl mx-4 sm:mx-6 md:mx-40 mt-6 md:mt-10 pb-4 px-3 sm:px-5 md:px-9">
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1" className="pt-4">
            <AccordionTrigger className="font-generalRegular hover:no-underline text-left" onClick={() => handleToggle('item-1')}>
              What is Unicapp?
            </AccordionTrigger>
            {openItem === 'item-1' && (
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-2">
            <AccordionTrigger className="font-generalRegular hover:no-underline text-left" onClick={() => handleToggle('item-2')}>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-3">
            <AccordionTrigger className="font-generalRegular hover:no-underline text-left" onClick={() => handleToggle('item-3')}>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-4">
            <AccordionTrigger className="font-generalRegular hover:no-underline text-left" onClick={() => handleToggle('item-4')}>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-5">
            <AccordionTrigger className="font-generalRegular hover:no-underline text-left" onClick={() => handleToggle('item-5')}>
