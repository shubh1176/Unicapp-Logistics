...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 justify-center bg-[#F1EDEA]">
        ...
        <div className="text-center bg-gradient-to-b h-5/6 from-[#8D14CE] to-[#470A68] text-white pb-24 pt-8 rounded-br-3xl rounded-bl-3xl flex flex-col justify-center items-center">
          <div className="flex flex-col items-center space-y-3">
            ...
            <p className="mt-6 text-2xl font-generalLight">
              No need to step out, ship with ease using our <br /> doorstep pickup and delivery service.
            </p>
          </div>
          ...
          <div className="mt-10 hover:cursor-pointer">
            <Image src={'/images/getEst.svg'} width={180} height={110} alt="Pickup" onClick={() => router.push('/estimate')} priority />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col content-center items-center mt-20 mb-20"> {/* Adjusted bottom margin */}
        <div>
