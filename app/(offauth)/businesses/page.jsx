    ...
    <div className="bg-[#F1EDEA]  max-w-screen overflow-hidden py-0 my-0">
      <div className="">
        ...
        <div className="h-[450px]  md:min-h-screen rounded-t-none  rounded-b-3xl md:mb-32 flex flex-col md:flex-row items-center  justify-evenly md:rounded-3xl bg-[linear-gradient(270deg,#9E3CE1_0%,#56217B_100%)] mb-64 md:mx-16 md:px-14 md:py-32">
          ...
          <div className="text-white space-y-6 w-full md:w-[60%] ">
            ...
            <p className=" hidden md:block pr-14">
              Enable your store or business to get anything delivered on-demand
              or nationwide. We promise a 5-star last-mile delivery experience
              for your customers. Trusted by leading companies for delivery
              service.
            </p>
            ...
            <ul className="space-y-6 font-montserrat hidden md:block">
              ...
              <li className="flex items-start space-x-2 w-[55%]">
                ...
                <div>
                  <h3 className="font-bold ">Pocket-friendly</h3>
                  <p className="text-[12px]">
                    We may not be the cheapest, but our prices are still lower
                    than what's currently on the market.
                  </p>
                </div>
              </li>
              {/* Feature 2 */}
              <li className="flex items-start space-x-2 w-[60%]">
                <span className="text-2xl mt-1">
                  <IoShieldCheckmark />
                </span>
                <div>
                  <h3 className="font-bold ">Secured</h3>
                  <p className="text-[12px]">
                    We ship exclusively with trusted courier partners, ensuring
                    your package is always secure.
                  </p>
                </div>
              </li>
              {/* Feature 3 */}
              <li className="flex items-start space-x-2 w-[55%]">
                ...
                <div>
                  <h3 className="font-bold ">24/7 Assistance</h3>
                  <p className="text-[12px]">
                    We're here for you 24/7 to address any issues you may have
                    with your shipments.
                  </p>
                </div>
              </li>
          ...
          <div className="w-full flex flex-row gap-12 justify-around md:gap-36 py-10 md:p-12  md:justify-center">
            <div className="flex flex-col items-center text-sm text-center">
              ...
              <span className="hidden md:block mt-2">
                We provide same day intracity <br /> deliveries, so that you can
                make <br /> your customers even happier!
              </span>
            </div>
            <div className="flex flex-col items-center text-sm text-center">
              <Image
              ...
              <span className="hidden md:block mt-2">
                Plan and schedule your <br /> pickups to ensure you never <br />{" "}
                miss a delivery
              </span>
            </div>
            <div className="flex flex-col items-center text-sm text-center">
              ...
              <span className="hidden md:block mt-2">
                We value your time, so we provide <br /> multiple drop-off
                points, eliminating the <br /> need to book each shipment
                separately.
              </span>
            </div>
          </div>
      ...
      <div className="z-10 hidden  md:flex flex-col items-center justify-center text-center mt-14 mb-11">
        <div className="hidden md:block absolute z-0 inset-0 top-[1900px]">
          <Image
            src={"/images/ribbonDesktopBusiness.png"}
            className="w-[1900px] h-[1030px] z-0 "
            width={2000}
            height={100}
            alt="Logo"
          />
        ...
        <div className="z-10">
          <h2 className="text-5xl font-generalSemiBold mb-4">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-y-20 gap-x-64 mt-28 mx-40 relative">
            ...
            <div>
              <h2 className="text-3xl font-generalSemiBold mb-4 mt-8">
                Easy Store Integration
              </h2>
              <span className="">
                You amplify sales, we simplify deliveries
              </span>
            </div>
            <div>
              <h2 className="text-3xl font-generalSemiBold mb-4 mt-8">
            ...
            <div>
              <Image
                src={"/images/DashboardLayout.svg"}
                height={356}
                width={356}
                alt="Dashboard"
              />
            ...
            <div>
              <Image
                src={"/images/CustomerSupportPicture.svg"}
                height={356}
                width={356}
      ...
      <div className="block  md:hidden mt-28 ">
        <Image
          src={"/images/deliverymadeeasy.png"}
          className="w-[1900px] z-0 "
          width={2000}
          height={100}
          objectFit="cover"
          alt="Ribbon Background"
      ...
      <div className="hidden md:flex justify-center items-center px-10 h-screen mt-40 mb-28">
        <Image
          src={"/images/businessgrouppage.svg"}
          height={544}
          width={1306}
          alt="Business Group"
        />
      ...
      <div className="block  md:hidden mt-28 px-8">
        <Image
          src={"/images/businessgrouppage2.png"}
          className=" z-0 "
          width={2000}
          height={100}
          objectFit="cover"
