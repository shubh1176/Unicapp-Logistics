...
export default function Page() {
  return(
    <div className=" flex flex-row items-center justify-between bg-[#F1EDEA] mt-20 pl-32">
      <div className="flex flex-col gap-1 items-center">
        <Image src={'/images/blackonwhitelogo.svg'} height={300} width={300} className='-translate-y-4' />
        <h1 className="font-generalMedium text-3xl -translate-y-4">Get started with your account</h1>
