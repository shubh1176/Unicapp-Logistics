...
import { ChevronLeft, ChevronRight, CircleUserRound, House, PackageOpen, ShieldCheck, Truck, User, UserRound, WalletMinimal, Building2, ChevronUp } from 'lucide-react';
                                    ...
                                    <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg shadow-inner">
                                      <div className="flex flex-col border rounded-lg bg-white px-4 py-2 pb-6">
                                        <div className='flex flex-row gap-2 mt-3'>
                                          <PackageOpen size={20} strokeWidth={1.25} /> <h4 className="font-bold mb-4"> Order Details</h4>
                                        </div>
              ...
              <div className="flex flex-col items-center w-full space-y-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-5xl"> {/* Increased max-w to 5xl */}
                  ...
                  {individualOrders.length > 0 ? (
                    <div className="overflow-x-auto">
                      <Table className="w-full"> {/* Set table width to full */}
