...
import { ArrowDown, ArrowUp, Box, Calendar, IndianRupee, MapPinIcon } from 'lucide-react';
          ...
          <div className="p-10 text-left -translate-x-8 -translate-y-8">
            <div className="mt-5 flex flex-col items-start">
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="ml-3 w-80">
                  <p className="text-sm font-generalRegular opacity-50">Delivery</p>
