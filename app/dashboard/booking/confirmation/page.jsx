...
function Page() {
  return (
    <div className="flex flex-col lg:flex-row h-screen lg:h-full bg-white">
      ...
      <div className="lg:w-1/2 w-full h-full flex items-center justify-center px-6 lg:px-10 bg-white">
        <RightDiv5 />
      </div>
    </div>
  );
