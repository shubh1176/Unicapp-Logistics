...
function Page() {
  return (
    <div className="flex flex-col lg:gap-4 lg:flex-row h-auto lg:min-h-screen bg-[#F1EDEA] lg:overflow-hidden">
      ...
      <div className="lg:w-1/2 w-full flex justify-center lg:justify-start px-6 lg:px-14 pb-10 lg:pb-0   lg:translate-x-20 lg:bg-[#F8F8F8] lg:overflow-y-scroll  lg:pt-10   ">
        <RightDiv3 />
      </div>
    </div>
  );
