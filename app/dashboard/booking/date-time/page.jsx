...
function Page() {
  return (
    <div className="flex flex-col gap-4 lg:flex-row h-auto lg:h-full bg-[#F1EDEA]">
      ...
      <div className="lg:w-1/2 w-full flex justify-center lg:justify-start px-6 lg:px-12 pb-10 lg:pb-0 lg:items-center lg:-translate-y-44 lg:translate-x-20 lg:ml-8">
        <RightDiv2 />
      </div>
    </div>
  );
