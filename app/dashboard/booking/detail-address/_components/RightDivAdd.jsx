  ...
  return (
    <div className="flex flex-col justify-center bg-white items-start h-full p-5 sm:p-10 lg:p-14 w-full sm:max-w-xl lg:max-w-full mx-auto lg:pt-28">
      ...
      <div className="w-full mt-4">
        <div className="mb-7">
          ...
          <Input
            ...
            className="mb-3 sm:w-64 lg:w-96 h-12 rounded-xl"
          ...
          <Input
            ...
            className="sm:w-64 lg:w-96 h-12 rounded-xl"
      ...
      <div className="flex justify-start mt-10 gap-3">
        ...
        <Button
          className="py-6 px-10 lg:w-80 sm:w-60 rounded-xl bg-[#8B14CC] text-white text-center hover:bg-[#8D26CA] hover:text-white"
          onClick={(e) => {
            e.preventDefault();
            handleContinue();
          }}
